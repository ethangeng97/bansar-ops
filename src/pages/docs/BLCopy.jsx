// ============================================================================
// BLCopy.jsx — 提单副本 (B/L Copy)
// 路由：#/docs/bl_copy/<shipment_id>
// 用途：提单已签发后的副本，证明运输事实但不能换货
// 与 DraftBL 区别：
//   - 无 DRAFT 水印，改为 "COPY - NON-NEGOTIABLE" 倾斜印章风
//   - 顶部警告改为 "副本，不可议付"
//   - 显示真实 Date of Issue（取 obl_issued_at 或 etd）
//   - 底部 NOTICE 改为副本声明
// ============================================================================
...
export default function BLCopy({ shipmentId, onBack }) {
  ...
  // 签发日期：obl_issued_at > etd > 今天
  const issueDate = s.obl_issued_at
    ? new Date(s.obl_issued_at).toLocaleDateString("en-CA")
    : (s.etd || new Date().toLocaleDateString("en-CA"));
      ...
      <div className="bl-a4">
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between",
          ...
          <div style={{ textAlign: "center", flex: 1 }}>
            ...
            <div style={{ fontSize: 9, color: "#666", fontWeight: 600, marginTop: 2 }}>
              COPY — Non-Negotiable / 副本，不可议付
            </div>
          </div>
        ...
        <div className="bl-grid">
          ...
          {/* Row 9: Freight & Charges | No. of Original B/L */}
          <div className="bl-row">
